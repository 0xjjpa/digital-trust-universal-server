...
module.exports = {
  ...
  discovery: {
    claims_in_assertion_claims_supported: {
      ...
      proof: { type: 'object', props: { proofId: { type: 'string' }, claims: { type: 'array', items: { type: 'string' } }, content: { type: 'object' }, content_type: { type: 'string' }, expires: { type: 'date' }, verified: { type: 'date' } } }
    }
  },
  claims: {
